...
export default function HeroSection() {
    return (
        <section className='flex flex-col items-center justify-center leading-6 mt-[3rem]' aria-label="ASaaS Template Hero">
            <h1 className={`${TITLE_TAILWIND_CLASS} scroll-m-20 font-semibold tracking-tight text-center max-w-[1120px] bg-gradient-to-b dark:text-white`}>
                ASaaS Template: Build & Ship Fast
            </h1>
                ...
                <div className="relative flex max-w-6xl justify-center overflow-hidden mt-7">
                    <div className="relative rounded-xl">
                        <Image
                            ...
                            alt="ASaaS Template Dashboard Preview"
                            width={1100}
                            height={550}
                            priority={true}
                        ...
                        <Image
                            ...
                            width={1100}
                            height={550}
                            alt="ASaaS Template Dark Mode Dashboard Preview"
                            priority={true}
